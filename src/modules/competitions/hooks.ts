...
import {
  ...
  getCompetitionsList,
  updateCompetition,
} from '@/services/api/methods/competitions'
...
export const useCompetitions = (params: FindAllCompetitionsParams) =>
  usePaginatedData<FindAllCompetitionsParams, CompetitionDto>(
    moduleName,
    params,
    getCompetitions,
  )
...
export const useCreateCompetition = () =>
  useCreateDocument<CreateCompetitonDto, CompetitionDto>(
    moduleName,
    createCompetition,
  )

export const useUpdateCompetition = (id: string) =>
  useUpdateDocument<UpdateCompetitionDto, CompetitionDto>(
    moduleName,
    id,
    updateCompetition,
  )
