...
import { OrganizationNoteAclDto, UpdateOrganizationNoteAclDto } from '../types'
import {
...
interface IEditFormProps {
  current: OrganizationNoteAclDto
  onSubmit: (data: UpdateOrganizationNoteAclDto) => void
  onCancelClick?: () => void
  fullwidth?: boolean
}

export const EditOrganizationNoteAclForm = ({
  current,
  onSubmit,
  onCancelClick,
  fullwidth,
