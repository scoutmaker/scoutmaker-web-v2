...
import { CreatePlayerStatsDto } from '../types'
import { generateCreateValidationSchema, initialValues } from './utils'

interface ICreateFormProps {
  onSubmit: (data: CreatePlayerStatsDto) => void
  onCancelClick?: () => void
  fullwidth?: boolean
...
export const CreatePlayerStatsForm = ({
  onSubmit,
  onCancelClick,
  matchesData,
  playersData,
  ...
  return (
    <Formik
      ...
      onSubmit={(data, { resetForm }) => {
        ...
        onSubmit(dataToSubmit as CreatePlayerStatsDto)
        resetForm()
      }}
    >
