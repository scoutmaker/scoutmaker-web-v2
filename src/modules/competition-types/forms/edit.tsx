...
import { CompetitionTypeDto, UpdateCompetitionTypeDto } from '../types'
import {
...
interface IEditRegionFormProps {
  current: CompetitionTypeDto
  onSubmit: (data: UpdateCompetitionTypeDto) => void
  onCancelClick?: () => void
  fullwidth?: boolean
}

export const EditCompetitionTypeForm = ({
  current,
  onSubmit,
  onCancelClick,
  fullwidth,
