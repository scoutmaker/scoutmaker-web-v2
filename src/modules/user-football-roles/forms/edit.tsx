...
import { UpdateUserFootballRoleDto, UserFootballRoleDto } from '../types'
import {
...
interface IEditFormProps {
  current: UserFootballRoleDto
  onSubmit: (data: UpdateUserFootballRoleDto) => void
  onCancelClick?: () => void
  fullwidth?: boolean
}

export const EditUserFootballRoleForm = ({
  current,
  onSubmit,
  onCancelClick,
  fullwidth
